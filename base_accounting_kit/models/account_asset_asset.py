...
class AccountAssetAsset(models.Model):
    ...
    method = fields.Selection(
        ...
        help="Pilih metode yang akan digunakan untuk menghitung jumlah garis penyusutan.\n  * Linear: Dihitung berdasarkan: Nilai Kotor / Jumlah Depresiasi\n"
             "  * Degresif: Dihitung berdasarkan: Nilai Residual * Faktor Degresif")
    method_number = fields.Integer(string='Number of Depreciations',
                                   readonly=True,
                                   default=5,
                                   help="Jumlah penyusutan yang diperlukan untuk mendepresiasi aset Anda")
    method_period = fields.Integer(string='Number of Months in a Period',
                                   required=True, readonly=True, default=12,
                                   help="Jumlah waktu antara dua depresiasi, dalam sebulan")
    ...
    prorata = fields.Boolean(string='Prorata Temporis', readonly=True,
                             help='Menunjukkan bahwa entri penyusutan pertama untuk aset ini harus dilakukan dari tanggal pembelian alih -alih tanggal pertama Januari / mulai tahun fiskal')
    ...
    salvage_value = fields.Float(string='Salvage Value', digits=0,
                                 readonly=True,
                                 help="Itu adalah jumlah yang Anda rencanakan untuk Anda miliki.")
