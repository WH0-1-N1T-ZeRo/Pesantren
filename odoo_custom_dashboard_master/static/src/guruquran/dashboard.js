...
import { GuruquranTahsinCardList, GuruquranTahfidzCardList } from "./card_list/card_list";
...
registry.category("actions").add("owl.guruquran_dashboard", OwlGuruquranDashboard);